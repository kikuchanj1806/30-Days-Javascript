...
Hầu hết các hoạt động chúng ta làm trong cuộc sống đều lặp đi lặp lại. Hãy tưởng tượng nếu tôi yêu cầu bạn in ra từ 0 đến 100 bằng console.log(). Để thực hiện nhiệm vụ đơn giản này, bạn có thể mất từ ​​2 đến 5 phút, loại nhiệm vụ tẻ nhạt và lặp đi lặp lại như vậy có thể được thực hiện bằng cách sử dụng vòng lặp.

Trong các ngôn ngữ lập trình để thực hiện tác vụ lặp đi lặp lại chúng ta sử dụng các loại vòng lặp khác nhau. Các ví dụ sau đây là các vòng lặp thường được sử dụng trong JavaScript và các ngôn ngữ lập trình khác.
...
Cộng tất cả các phần tử trong mảng
...
Tạo một mảng mới dựa trên mảng hiện có
...
Chúng tôi sử dụng vòng lặp for cho mảng. Nó rất tiện để lặp qua một mảng nếu chúng ta không quan tâm đến chỉ mục của từng phần tử trong mảng.
...
Break được sử dụng để ngắt một vòng lặp.
...
Đoạn mã trên dừng nếu tìm thấy 3 trong quá trình lặp.

### continue

Chúng tôi sử dụng từ khóa _continue_ bỏ qua một số lần lặp nhất định.
